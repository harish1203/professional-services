...
def validate_folder_access(folder):
    if os.access(folder, os.F_OK) and os.access(folder, os.R_OK) and os.access(folder, os.W_OK):
        return True
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--execute', dest='execute', default=True,
        required=True,
    ...
    parser.add_argument(
        '--generate_report', dest='det_report', default=True,
    ...
    parser.add_argument(
        '--output_folder', dest='output_folder', default='./outputs',
